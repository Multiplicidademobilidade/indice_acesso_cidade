...
calcular_acess_muni <- function(sigla_muni, ano, res = '08', BFCA = FALSE) {
  ...
  #                        "mat_total", "mat_infantil", "mat_fundamental", "mat_medio", "cras_total") :=
  ...
  #                             i.mat_total, i.mat_infantil, i.mat_fundamental, i.mat_medio, i.cras_total)]    
...
furrr::future_walk(munis_list$munis_metro[ano_metro == 2019]$abrev_muni, calcular_acess_muni, ano = 2019, res = '07')

# lapply(munis_list$munis_metro[ano_metro == 2019]$abrev_muni, calcular_acess_muni, ano = 2019, res = '07')
