...
filtrar_malha_viaria_br <- function(ano) {
...
filtrar_malha_viaria_br(ano = 2019)
...
extrai_malha_viaria <- function(muni, ano) {
...
ano = 2020
purrr::walk(munis_list$munis_metro[ano_metro == ano]$abrev_muni, extrai_malha_viaria, ano = 2020)
system.time(extrai_malha_viaria(muni = "poa", ano = 2020))
